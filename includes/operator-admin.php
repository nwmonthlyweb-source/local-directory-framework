    ...
    <div class="wrap">
        ...
        <?php if (!empty($status['ready'])) : ?>
            ...
            <p>
                <?php
                echo esc_html__(
                    'Upload a valid AI state ZIP to compare it with current normalized records. The preview reports additions, changes, unchanged records, records missing from the upload, and conflicts. It does not import or change data.',
                    'local-directory-framework'
                );
                ?>
            </p>
            ...
            >
                <input
                    type="hidden"
                    name="action"
                    value="nwmd_directory_preview_ai_state"
                >
