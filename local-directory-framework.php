...
define('NWMD_DIRECTORY_VERSION', '0.1.104');
...
require_once NWMD_DIRECTORY_PATH . 'includes/operator-preview-storage.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-preview-validation.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-draft-approval.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-legacy-cleanup.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-ai-state-export.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-ai-state-validation.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-ai-state-preview.php';
require_once NWMD_DIRECTORY_PATH . 'includes/operator-ai-state-import.php';
...
/**
 * Clear scheduled plugin events on deactivation.
 */
function nwmd_directory_deactivate() {
